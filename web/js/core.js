...
const A={
  ...
  startRecon:b=>apiFetch('/recon/scan',{method:'POST',body:JSON.stringify(b)}),
  listRecon:()=>apiFetch('/recon/scans'),getRecon:id=>apiFetch(`/recon/scans/${id}`),
  reconRouter:b=>apiFetch('/recon/router',{method:'POST',body:JSON.stringify(b)}),
  reconDiscover:cidr=>apiFetch(`/recon/discover?cidr=${encodeURIComponent(cidr)}`,{method:'POST'}),
